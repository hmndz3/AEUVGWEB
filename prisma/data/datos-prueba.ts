...
export const NOMBRES_PRUEBA = {
  ...
  eventoVariosDias: `${MARCADOR_PRUEBA} Semana de Emprendimiento 2027`,
  eventoCancelado: `${MARCADOR_PRUEBA} Torneo Interfacultades Suspendido`,
  eventoBorrador: `${MARCADOR_PRUEBA} Taller de Liderazgo en Preparación`,
  eventoLejano: `${MARCADOR_PRUEBA} Feria de Clubes 2027`,
...
export const FECHAS_PRUEBA = {
  ...
  // Abarca tres días: el calendario debe mostrarlo en cada uno de ellos.
  eventoVariosDiasInicio: new Date("2027-04-12T14:00:00.000Z"),
  eventoVariosDiasFin: new Date("2027-04-14T23:00:00.000Z"),
  eventoCanceladoInicio: new Date("2027-02-25T15:00:00.000Z"),
  eventoCanceladoFin: new Date("2027-02-25T20:00:00.000Z"),
  eventoBorradorInicio: new Date("2027-05-06T15:00:00.000Z"),
  eventoBorradorFin: new Date("2027-05-06T17:00:00.000Z"),
  eventoLejanoInicio: new Date("2027-07-21T14:00:00.000Z"),
  eventoLejanoFin: new Date("2027-07-21T21:00:00.000Z"),
